...
// 함수 타입
// React 월드
// React 엘리먼트 생성 과정에서는 반드시 React.createElement API를 사용해야함

// 사용법 1
// 웹브라우저가 인식 가능한 HTML 표준 엘리먼트 이름(문자 값)
// console.log(React.createElement('section'))
...
// ReactDOM의 절차
// 1. React DOM의 루트를 생성한다. (실제 DOM 요소를 전달)
// ReactDOM.createRoot(document.getElementById('root'))
// 2. 생성된 ReactDOm의 루트 요소(객체)를 통해 실제 DOM에 렌더링한다.
// reactDomRoot.render()
